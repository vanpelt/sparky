...
func forwardableFlags() []forwardableFlag {
	return []forwardableFlag{
		...
		strFlag("guest-subnet", func(c Config) string { return c.GuestSubnet }),
		strFlag("node-control-transport", func(c Config) string { return c.NodeControlTransport }),
		strFlag("node-control-rollout", func(c Config) string { return c.NodeControlRollout }),
		strFlag("node-grpc-addr", func(c Config) string { return c.NodeGRPCAddr }),
		strFlag("gateway-grpc-addr", func(c Config) string { return c.GatewayGRPCAddr }),
		strFlag("guest-data-transport", func(c Config) string { return c.GuestDataTransport }),
		intFlag("routed-guest-canary-percent", func(c Config) int { return c.RoutedGuestCanaryPercent }),
		strFlag("cluster-id", func(c Config) string { return c.ClusterID }),
